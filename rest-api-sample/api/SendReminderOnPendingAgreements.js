...
(function(factory) {
    ...
    module.exports = factory(require('../../rest-api-sdk/src/index'), require('../utils/ReminderUtils'), require('../utils/AgreementUtils'), require('../utils/Constants'), require('../utils/Errors'), require('../utils/ApiUtils'));
