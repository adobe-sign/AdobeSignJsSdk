...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.WebhooksApi();
  });
  ...
  describe('WebhooksApi', function() {
    ...
    describe('getWebhookInfo', function() {
      it('should call getWebhookInfo successfully', function(done) {
        //uncomment below and update the code to test getWebhookInfo
        //instance.getWebhookInfo(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateWebhookState', function() {
      it('should call updateWebhookState successfully', function(done) {
        //uncomment below and update the code to test updateWebhookState
        //instance.updateWebhookState(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
