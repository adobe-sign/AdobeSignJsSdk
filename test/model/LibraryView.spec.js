...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.LibraryView();
  });
  ...
  describe('LibraryView', function() {
    it('should create an instance of LibraryView', function() {
      // uncomment below and update the code to test LibraryView
      //var instane = new SwaggerJsClient.LibraryView();
      //expect(instance).to.be.a(SwaggerJsClient.LibraryView);
    });
