...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SenderInfo();
  });
  ...
  describe('SenderInfo', function() {
    it('should create an instance of SenderInfo', function() {
      // uncomment below and update the code to test SenderInfo
      //var instane = new SwaggerJsClient.SenderInfo();
      //expect(instance).to.be.a(SwaggerJsClient.SenderInfo);
    });
