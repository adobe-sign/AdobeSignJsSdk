...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.WidgetView();
  });
  ...
  describe('WidgetView', function() {
    it('should create an instance of WidgetView', function() {
      // uncomment below and update the code to test WidgetView
      //var instane = new SwaggerJsClient.WidgetView();
      //expect(instance).to.be.a(SwaggerJsClient.WidgetView);
    });
