...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.LibraryDocumentInfo();
  });
  ...
  describe('LibraryDocumentInfo', function() {
    it('should create an instance of LibraryDocumentInfo', function() {
      // uncomment below and update the code to test LibraryDocumentInfo
      //var instane = new SwaggerJsClient.LibraryDocumentInfo();
      //expect(instance).to.be.a(SwaggerJsClient.LibraryDocumentInfo);
    });
