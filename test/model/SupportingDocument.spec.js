...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.SupportingDocument();
  });
  ...
  describe('SupportingDocument', function() {
    it('should create an instance of SupportingDocument', function() {
      // uncomment below and update the code to test SupportingDocument
      //var instane = new SwaggerJsClient.SupportingDocument();
      //expect(instance).to.be.a(SwaggerJsClient.SupportingDocument);
    });
