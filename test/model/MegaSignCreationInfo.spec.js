...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.MegaSignCreationInfo();
  });
  ...
  describe('MegaSignCreationInfo', function() {
    it('should create an instance of MegaSignCreationInfo', function() {
      // uncomment below and update the code to test MegaSignCreationInfo
      //var instane = new SwaggerJsClient.MegaSignCreationInfo();
      //expect(instance).to.be.a(SwaggerJsClient.MegaSignCreationInfo);
    });
    ...
    it('should have the property childAgreementsInfo (base name: "childAgreementsInfo")', function() {
      // uncomment below and update the code to test the property childAgreementsInfo
      //var instane = new SwaggerJsClient.MegaSignCreationInfo();
      //expect(instance).to.be();
    });
