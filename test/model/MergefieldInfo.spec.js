...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.MergefieldInfo();
  });
  ...
  describe('MergefieldInfo', function() {
    it('should create an instance of MergefieldInfo', function() {
      // uncomment below and update the code to test MergefieldInfo
      //var instane = new SwaggerJsClient.MergefieldInfo();
      //expect(instance).to.be.a(SwaggerJsClient.MergefieldInfo);
    });
