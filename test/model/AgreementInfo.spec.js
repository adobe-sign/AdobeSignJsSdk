...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.AgreementInfo();
  });
  ...
  describe('AgreementInfo', function() {
    it('should create an instance of AgreementInfo', function() {
      // uncomment below and update the code to test AgreementInfo
      //var instane = new SwaggerJsClient.AgreementInfo();
      //expect(instance).to.be.a(SwaggerJsClient.AgreementInfo);
    });
