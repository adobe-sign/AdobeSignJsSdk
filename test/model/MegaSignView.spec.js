...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.MegaSignView();
  });
  ...
  describe('MegaSignView', function() {
    it('should create an instance of MegaSignView', function() {
      // uncomment below and update the code to test MegaSignView
      //var instane = new SwaggerJsClient.MegaSignView();
      //expect(instance).to.be.a(SwaggerJsClient.MegaSignView);
    });
