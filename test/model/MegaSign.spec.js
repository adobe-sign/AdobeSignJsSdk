...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.MegaSign();
  });
  ...
  describe('MegaSign', function() {
    it('should create an instance of MegaSign', function() {
      // uncomment below and update the code to test MegaSign
      //var instane = new SwaggerJsClient.MegaSign();
      //expect(instance).to.be.a(SwaggerJsClient.MegaSign);
    });
