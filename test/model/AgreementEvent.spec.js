...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.AgreementEvent();
  });
  ...
  describe('AgreementEvent', function() {
    it('should create an instance of AgreementEvent', function() {
      // uncomment below and update the code to test AgreementEvent
      //var instane = new SwaggerJsClient.AgreementEvent();
      //expect(instance).to.be.a(SwaggerJsClient.AgreementEvent);
    });
