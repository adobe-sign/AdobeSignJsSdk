...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.UserWebhook();
  });
  ...
  describe('UserWebhook', function() {
    it('should create an instance of UserWebhook', function() {
      // uncomment below and update the code to test UserWebhook
      //var instane = new SwaggerJsClient.UserWebhook();
      //expect(instance).to.be.a(SwaggerJsClient.UserWebhook);
    });
