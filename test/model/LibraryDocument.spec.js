...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.LibraryDocument();
  });
  ...
  describe('LibraryDocument', function() {
    it('should create an instance of LibraryDocument', function() {
      // uncomment below and update the code to test LibraryDocument
      //var instane = new SwaggerJsClient.LibraryDocument();
      //expect(instance).to.be.a(SwaggerJsClient.LibraryDocument);
    });
