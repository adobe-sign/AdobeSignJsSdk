...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SwaggerJsClient.LibraryDocumentEvent();
  });
  ...
  describe('LibraryDocumentEvent', function() {
    it('should create an instance of LibraryDocumentEvent', function() {
      // uncomment below and update the code to test LibraryDocumentEvent
      //var instane = new SwaggerJsClient.LibraryDocumentEvent();
      //expect(instance).to.be.a(SwaggerJsClient.LibraryDocumentEvent);
    });
