...
(function(factory) {
  ...
  var LibDocumentHistoryEvent = function() {
    ...
    * @return  Location of the device that created the event (This value may be null due to limited privileges) { LibDocEventDeviceLocation }
    * @instance
    */
    ...
    * @param deviceLocation { LibDocEventDeviceLocation } Location of the device that created the event (This value may be null due to limited privileges)
    * @instance
    */
