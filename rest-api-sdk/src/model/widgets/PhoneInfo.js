...
(function(factory) {
  ...
  var PhoneInfo = function() {
    ...
    * @return  The phoneInfo country code required for the counter signer to view and sign the widget if authentication type is PHONE { String }
    * @instance
    */
    ...
    * @param countryCode { String } The phoneInfo country code required for the counter signer to view and sign the widget if authentication type is PHONE
    * @instance
    */
    ...
    * The phoneInfo country code required for the counter signer to view and sign the widget if authentication type is PHONE
    * @function setPhone
    * @param phone { String } The phoneInfo country code required for the counter signer to view and sign the widget if authentication type is PHONE
    * @instance
    */
