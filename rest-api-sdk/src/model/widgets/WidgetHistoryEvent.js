...
(function(factory) {
  ...
  var WidgetHistoryEvent = function() {
    ...
    * @return  Location of the device that created the event (This value may be null due to limited privileges) { WidgetEventDeviceLocation }
    * @instance
    */
    ...
    * @param deviceLocation { WidgetEventDeviceLocation } Location of the device that created the event (This value may be null due to limited privileges)
    * @instance
    */
    ...
    * @function getType
    * @return  Type of the widget event { String }
    * @instance
    */
    ...
    * Type of the widget event
    * @function setType
    * @param type { String } Type of the widget event
    * @instance
    */
    ...
    * @return  An ID which uniquely identifies the version of the widget associated with this audit event { String }
    * @instance
    */
    ...
    * @param versionId { String } An ID which uniquely identifies the version of the widget associated with this audit event
    * @instance
    */
