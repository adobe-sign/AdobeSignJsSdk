...
(function(factory) {
  ...
  var AgreementStatusUpdateInfo = function() {
    ...
    * @function getComment
    * @return  An optional comment describing to the recipient why you want to cancel the transaction { String }
    * @instance
    */
    ...
    * An optional comment describing to the recipient why you want to cancel the transaction
    * @function setComment
    * @param comment { String } An optional comment describing to the recipient why you want to cancel the transaction
    * @instance
    */
    ...
    * @return  Whether or not you would like the recipient to be notified that the transaction has been cancelled. The notification is mandatory if any party has already signed this document. The default value is false { Boolean }
    * @instance
    */
    ...
    * @param notifySigner { Boolean } Whether or not you would like the recipient to be notified that the transaction has been cancelled. The notification is mandatory if any party has already signed this document. The default value is false
    * @instance
    */
    ...
    * @function getValue
    * @return  The state to which the agreement is to be updated. The only valid state for this variable is currently, CANCEL { String }
    * @instance
    */
    ...
    * The state to which the agreement is to be updated. The only valid state for this variable is currently, CANCEL
    * @function setValue
    * @param value { String } The state to which the agreement is to be updated. The only valid state for this variable is currently, CANCEL
    * @instance
    */
