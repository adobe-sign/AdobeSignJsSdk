...
(function (factory) {
        ...
        module.exports = factory(require('../../utils/TestData'), require('../../utils/ViewUtils'), require('../../utils/LibraryDocumentUtils'), require('../../../src/utils/validator/SdkErrorCodes'), require('../../utils/ApiUtils'), require('../../../src/utils/StringUtil'), require('chai'));
