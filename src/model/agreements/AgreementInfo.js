...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.AgreementInfo = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.AgreementCcInfo, root.SwaggerJsClient.EmailOption, root.SwaggerJsClient.ExternalId, root.SwaggerJsClient.FileInfo, root.SwaggerJsClient.MergefieldInfo, root.SwaggerJsClient.OfflineDeviceInfo, root.SwaggerJsClient.ParticipantSetInfo, root.SwaggerJsClient.PostSignOption, root.SwaggerJsClient.SecurityOption, root.SwaggerJsClient.VaultingInfo);
  }
  ...
  /**
   * The AgreementInfo model module.
   ...
   * @member {module:model/agreements/AgreementInfo.ReminderFrequencyEnum} reminderFrequency
   */
   ...
   * @member {module:model/agreements/AgreementInfo.SignatureTypeEnum} signatureType
   */
   ...
   * @member {module:model/agreements/AgreementInfo.StateEnum} state
   */
  exports.prototype['state'] = undefined;
  /**
   * This is a server generated attribute which provides the detailed status of an agreement.
   * @member {module:model/agreements/AgreementInfo.StatusEnum} status
   */
