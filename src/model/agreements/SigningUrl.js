...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.SigningUrl = factory(root.SwaggerJsClient.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('esignUrl')) {
        obj['esignUrl'] = ApiClient.convertToType(data['esignUrl'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * The email address of the signer associated with this signing url
   * @member {String} esignUrl
   */
  exports.prototype['esignUrl'] = undefined;
