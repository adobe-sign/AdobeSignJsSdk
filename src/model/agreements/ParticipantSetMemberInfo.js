...
(function(root, factory) {
   ...
   * @module model/agreements/ParticipantSetMemberInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>ParticipantSetMemberInfo</code>.
   * @alias module:model/agreements/ParticipantSetMemberInfo
   * @class
   */
   ...
   * @param {module:model/agreements/ParticipantSetMemberInfo} obj Optional instance to populate.
   * @return {module:model/agreements/ParticipantSetMemberInfo} The populated <code>ParticipantSetMemberInfo</code> instance.
   */
