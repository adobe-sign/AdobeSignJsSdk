...
(function(root, factory) {
   ...
   * @module model/agreements/ParticipantSecurityOption
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>ParticipantSecurityOption</code>.
   * @alias module:model/agreements/ParticipantSecurityOption
   * @class
   */
   ...
   * @param {module:model/agreements/ParticipantSecurityOption} obj Optional instance to populate.
   * @return {module:model/agreements/ParticipantSecurityOption} The populated <code>ParticipantSecurityOption</code> instance.
   */
   ...
   * @member {module:model/agreements/ParticipantSecurityOption.AuthenticationMethodEnum} authenticationMethod
   */
