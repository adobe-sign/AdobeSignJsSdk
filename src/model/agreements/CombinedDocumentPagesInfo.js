...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/agreements/DocumentPageInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DocumentPageInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggerJsClient) {
      root.SwaggerJsClient = {};
    }
    root.SwaggerJsClient.CombinedDocumentPagesInfo = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.DocumentPageInfo);
  }
}(this, function(ApiClient, DocumentPageInfo) {
  'use strict';
  ...
  /**
   * The CombinedDocumentPagesInfo model module.
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('documentPagesInfo')) {
        obj['documentPagesInfo'] = ApiClient.convertToType(data['documentPagesInfo'], [DocumentPageInfo]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/agreements/DocumentPageInfo>} documentPagesInfo
   */
  exports.prototype['documentPagesInfo'] = undefined;
