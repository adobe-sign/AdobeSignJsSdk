...
(function(root, factory) {
   ...
   * @module model/agreements/CCParticipantInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>CCParticipantInfo</code>.
   * @alias module:model/agreements/CCParticipantInfo
   * @class
   */
   ...
   * @param {module:model/agreements/CCParticipantInfo} obj Optional instance to populate.
   * @return {module:model/agreements/CCParticipantInfo} The populated <code>CCParticipantInfo</code> instance.
   */
