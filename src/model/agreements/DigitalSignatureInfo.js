...
(function(root, factory) {
   ...
   * @module model/agreements/DigitalSignatureInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>DigitalSignatureInfo</code>.
   * @alias module:model/agreements/DigitalSignatureInfo
   * @class
   */
   ...
   * @param {module:model/agreements/DigitalSignatureInfo} obj Optional instance to populate.
   * @return {module:model/agreements/DigitalSignatureInfo} The populated <code>DigitalSignatureInfo</code> instance.
   */
