...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/agreements/PageImageUrl'], factory);
   ...
   * @member {module:model/agreements/DocumentImageUrls.ImageSizeEnum} imageSize
   */
  exports.prototype['imageSize'] = undefined;
  /**
   * A list of image url (one per page).
   * @member {Array.<module:model/agreements/PageImageUrl>} imageURLs
   */
