...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/agreements/DeviceLocation', 'model/agreements/DigitalSignatureInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DeviceLocation'), require('./DigitalSignatureInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggerJsClient) {
      root.SwaggerJsClient = {};
    }
    root.SwaggerJsClient.AgreementEvent = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.DeviceLocation, root.SwaggerJsClient.DigitalSignatureInfo);
  }
}(this, function(ApiClient, DeviceLocation, DigitalSignatureInfo) {
  'use strict';
  ...
  /**
   * The AgreementEvent model module.
   * @module model/agreements/AgreementEvent
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>AgreementEvent</code>.
   * @alias module:model/agreements/AgreementEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>AgreementEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/agreements/AgreementEvent} obj Optional instance to populate.
   * @return {module:model/agreements/AgreementEvent} The populated <code>AgreementEvent</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('deviceLocation')) {
        obj['deviceLocation'] = DeviceLocation.constructFromObject(data['deviceLocation']);
      }
   ...
   * @member {module:model/agreements/DeviceLocation} deviceLocation
   */
   ...
   * @member {module:model/agreements/DigitalSignatureInfo} digitalSignatureInfo
   */
   ...
   * @member {module:model/agreements/AgreementEvent.ParticipantRoleEnum} participantRole
   */
   ...
   * @member {module:model/agreements/AgreementEvent.TypeEnum} type
   */
  ...
  exports.TypeEnum = {
    /**
     * value: "ACCESS_CODE_GENERATED"
     * @const
     */
    "ACCESS_CODE_GENERATED": "ACCESS_CODE_GENERATED",
    /**
     * value: "ACCESS_CODE_CONSUMED"
     * @const
     */
    ...
    "ACTIVATED": "ACTIVATED",
    /**
     * value: "DIGITAL_SIGN_UIDAI_SIGNER_CONSENT"
     * @const
     */
