...
(function(root, factory) {
   ...
   * @module model/agreements/SenderInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>SenderInfo</code>.
   * @alias module:model/agreements/SenderInfo
   * @class
   */
   ...
   * @param {module:model/agreements/SenderInfo} obj Optional instance to populate.
   * @return {module:model/agreements/SenderInfo} The populated <code>SenderInfo</code> instance.
   */
   ...
   * @member {module:model/agreements/SenderInfo.StatusEnum} status
   */
