...
(function(root, factory) {
   ...
   * @module model/agreements/CommonViewConfiguration
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>CommonViewConfiguration</code>.
   * @alias module:model/agreements/CommonViewConfiguration
   * @class
   */
   ...
   * @param {module:model/agreements/CommonViewConfiguration} obj Optional instance to populate.
   * @return {module:model/agreements/CommonViewConfiguration} The populated <code>CommonViewConfiguration</code> instance.
   */
