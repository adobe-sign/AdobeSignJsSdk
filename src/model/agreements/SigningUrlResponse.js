...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/agreements/SigningUrlSetInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SigningUrlSetInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggerJsClient) {
      root.SwaggerJsClient = {};
    }
    root.SwaggerJsClient.SigningUrlResponse = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.SigningUrlSetInfo);
  }
}(this, function(ApiClient, SigningUrlSetInfo) {
  'use strict';
  ...
  /**
   * The SigningUrlResponse model module.
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('signingUrlSetInfos')) {
        obj['signingUrlSetInfos'] = ApiClient.convertToType(data['signingUrlSetInfos'], [SigningUrlSetInfo]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/agreements/SigningUrlSetInfo>} signingUrlSetInfos
   */
  exports.prototype['signingUrlSetInfos'] = undefined;
