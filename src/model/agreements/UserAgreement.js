...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/agreements/DisplayParticipantSetInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DisplayParticipantSetInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggerJsClient) {
      root.SwaggerJsClient = {};
    }
    root.SwaggerJsClient.UserAgreement = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.DisplayParticipantSetInfo);
  }
}(this, function(ApiClient, DisplayParticipantSetInfo) {
  'use strict';
  ...
  /**
   * The UserAgreement model module.
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('displayParticipantSetInfos')) {
        obj['displayParticipantSetInfos'] = ApiClient.convertToType(data['displayParticipantSetInfos'], [DisplayParticipantSetInfo]);
      }
   ...
   * @member {Array.<module:model/agreements/DisplayParticipantSetInfo>} displayParticipantSetInfos
   */
   ...
   * @member {module:model/agreements/UserAgreement.StatusEnum} status
   */
