...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.AgreementView = factory(root.SwaggerJsClient.ApiClient);
  }
  ...
  /**
   * The AgreementView model module.
   * @module model/agreements/AgreementView
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>AgreementView</code>.
   * @alias module:model/agreements/AgreementView
   * @class
   */
  ...
  /**
   * Constructs a <code>AgreementView</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/agreements/AgreementView} obj Optional instance to populate.
   * @return {module:model/agreements/AgreementView} The populated <code>AgreementView</code> instance.
   */
   ...
   * @member {module:model/agreements/AgreementView.NameEnum} name
   */
