...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/agreements/Document', 'model/agreements/URLFileInfo'], factory);
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('libraryDocumentId')) {
        obj['libraryDocumentId'] = ApiClient.convertToType(data['libraryDocumentId'], 'String');
      }
   ...
   * @member {module:model/agreements/Document} document
   */
   ...
   * @member {String} libraryDocumentId
   */
  exports.prototype['libraryDocumentId'] = undefined;
  /**
   ...
   * @member {module:model/agreements/URLFileInfo} urlFileInfo
   */
