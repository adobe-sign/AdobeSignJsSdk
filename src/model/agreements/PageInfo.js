...
(function(root, factory) {
   ...
   * @module model/agreements/PageInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>PageInfo</code>.
   * @alias module:model/agreements/PageInfo
   * @class
   */
   ...
   * @param {module:model/agreements/PageInfo} obj Optional instance to populate.
   * @return {module:model/agreements/PageInfo} The populated <code>PageInfo</code> instance.
   */
