...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.UserView = factory(root.SwaggerJsClient.ApiClient);
  }
   ...
   * @module model/user/UserView
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>UserView</code>.
   * @alias module:model/user/UserView
   * @class
   */
   ...
   * @param {module:model/user/UserView} obj Optional instance to populate.
   * @return {module:model/user/UserView} The populated <code>UserView</code> instance.
   */
   ...
   * @member {module:model/user/UserView.NameEnum} name
   */
