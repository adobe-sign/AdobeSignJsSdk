...
(function(root, factory) {
   ...
   * @module model/user/PageInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>PageInfo</code>.
   * @alias module:model/user/PageInfo
   * @class
   */
   ...
   * @param {module:model/user/PageInfo} obj Optional instance to populate.
   * @return {module:model/user/PageInfo} The populated <code>PageInfo</code> instance.
   */
