...
(function(root, factory) {
   ...
   * @module model/megaSigns/CommonViewConfiguration
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>CommonViewConfiguration</code>.
   * @alias module:model/megaSigns/CommonViewConfiguration
   * @class
   */
   ...
   * @param {module:model/megaSigns/CommonViewConfiguration} obj Optional instance to populate.
   * @return {module:model/megaSigns/CommonViewConfiguration} The populated <code>CommonViewConfiguration</code> instance.
   */
