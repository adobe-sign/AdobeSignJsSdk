...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/megaSigns/DeviceLocation', 'model/megaSigns/DigitalSignatureInfo'], factory);
    ...
    root.SwaggerJsClient.MegasignEvent = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.DeviceLocation, root.SwaggerJsClient.DigitalSignatureInfo);
  }
  ...
  /**
   * The MegasignEvent model module.
   * @module model/megaSigns/MegasignEvent
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>MegasignEvent</code>.
   * @alias module:model/megaSigns/MegasignEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>MegasignEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/megaSigns/MegasignEvent} obj Optional instance to populate.
   * @return {module:model/megaSigns/MegasignEvent} The populated <code>MegasignEvent</code> instance.
   */
   ...
   * @member {module:model/megaSigns/DeviceLocation} deviceLocation
   */
   ...
   * @member {module:model/megaSigns/DigitalSignatureInfo} digitalSignatureInfo
   */
   ...
   * @member {module:model/megaSigns/MegasignEvent.ParticipantRoleEnum} participantRole
   */
   ...
   * @member {module:model/megaSigns/MegasignEvent.TypeEnum} type
   */
