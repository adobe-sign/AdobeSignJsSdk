...
(function(root, factory) {
   ...
   * @module model/megaSigns/PageInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>PageInfo</code>.
   * @alias module:model/megaSigns/PageInfo
   * @class
   */
   ...
   * @param {module:model/megaSigns/PageInfo} obj Optional instance to populate.
   * @return {module:model/megaSigns/PageInfo} The populated <code>PageInfo</code> instance.
   */
