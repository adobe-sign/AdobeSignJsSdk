...
(function(root, factory) {
   ...
   * @module model/widgets/CommonViewConfiguration
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>CommonViewConfiguration</code>.
   * @alias module:model/widgets/CommonViewConfiguration
   * @class
   */
   ...
   * @param {module:model/widgets/CommonViewConfiguration} obj Optional instance to populate.
   * @return {module:model/widgets/CommonViewConfiguration} The populated <code>CommonViewConfiguration</code> instance.
   */
