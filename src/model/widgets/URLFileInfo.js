...
(function(root, factory) {
   ...
   * @module model/widgets/URLFileInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>URLFileInfo</code>.
   * @alias module:model/widgets/URLFileInfo
   * @class
   */
   ...
   * @param {module:model/widgets/URLFileInfo} obj Optional instance to populate.
   * @return {module:model/widgets/URLFileInfo} The populated <code>URLFileInfo</code> instance.
   */
