...
(function(root, factory) {
   ...
   * @module model/widgets/DetailedParticipantInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>DetailedParticipantInfo</code>.
   * @alias module:model/widgets/DetailedParticipantInfo
   * @class
   */
   ...
   * @param {module:model/widgets/DetailedParticipantInfo} obj Optional instance to populate.
   * @return {module:model/widgets/DetailedParticipantInfo} The populated <code>DetailedParticipantInfo</code> instance.
   */
   ...
   * @member {module:model/widgets/DetailedParticipantInfo.StatusEnum} status
   */
