...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.WidgetView = factory(root.SwaggerJsClient.ApiClient);
  }
  ...
  /**
   * The WidgetView model module.
   * @module model/widgets/WidgetView
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>WidgetView</code>.
   * @alias module:model/widgets/WidgetView
   * @class
   */
  ...
  /**
   * Constructs a <code>WidgetView</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/widgets/WidgetView} obj Optional instance to populate.
   * @return {module:model/widgets/WidgetView} The populated <code>WidgetView</code> instance.
   */
   ...
   * @member {module:model/widgets/WidgetView.NameEnum} name
   */
