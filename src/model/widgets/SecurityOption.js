...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.SecurityOption = factory(root.SwaggerJsClient.ApiClient);
  }
  ...
  /**
   * The SecurityOption model module.
   * @module model/widgets/SecurityOption
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>SecurityOption</code>.
   * @alias module:model/widgets/SecurityOption
   * @class
   */
   ...
   * @param {module:model/widgets/SecurityOption} obj Optional instance to populate.
   * @return {module:model/widgets/SecurityOption} The populated <code>SecurityOption</code> instance.
   */
