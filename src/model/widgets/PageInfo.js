...
(function(root, factory) {
   ...
   * @module model/widgets/PageInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>PageInfo</code>.
   * @alias module:model/widgets/PageInfo
   * @class
   */
   ...
   * @param {module:model/widgets/PageInfo} obj Optional instance to populate.
   * @return {module:model/widgets/PageInfo} The populated <code>PageInfo</code> instance.
   */
