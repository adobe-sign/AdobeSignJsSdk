...
(function(root, factory) {
   ...
   * @module model/widgets/DigitalSignatureInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>DigitalSignatureInfo</code>.
   * @alias module:model/widgets/DigitalSignatureInfo
   * @class
   */
   ...
   * @param {module:model/widgets/DigitalSignatureInfo} obj Optional instance to populate.
   * @return {module:model/widgets/DigitalSignatureInfo} The populated <code>DigitalSignatureInfo</code> instance.
   */
