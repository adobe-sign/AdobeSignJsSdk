...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/libraryDocuments/Document'], factory);
    ...
    root.SwaggerJsClient.Documents = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.Document);
  }
  ...
  /**
   * A list of documents
   * @member {Array.<module:model/libraryDocuments/Document>} documents
   */
