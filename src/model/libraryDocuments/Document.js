...
(function(root, factory) {
   ...
   * @module model/libraryDocuments/Document
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>Document</code>.
   * @alias module:model/libraryDocuments/Document
   * @class
   */
   ...
   * @param {module:model/libraryDocuments/Document} obj Optional instance to populate.
   * @return {module:model/libraryDocuments/Document} The populated <code>Document</code> instance.
   */
