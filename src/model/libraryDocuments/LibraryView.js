...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.LibraryView = factory(root.SwaggerJsClient.ApiClient);
  }
  ...
  /**
   * The LibraryView model module.
   * @module model/libraryDocuments/LibraryView
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>LibraryView</code>.
   * @alias module:model/libraryDocuments/LibraryView
   * @class
   */
  ...
  /**
   * Constructs a <code>LibraryView</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/libraryDocuments/LibraryView} obj Optional instance to populate.
   * @return {module:model/libraryDocuments/LibraryView} The populated <code>LibraryView</code> instance.
   */
   ...
   * @member {module:model/libraryDocuments/LibraryView.NameEnum} name
   */
