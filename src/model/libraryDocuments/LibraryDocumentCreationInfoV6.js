...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SwaggerJsClient.LibraryDocumentCreationInfoV6 = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.FileInfo);
  }
  ...
  /**
   * The LibraryDocumentCreationInfoV6 model module.
   * @module model/libraryDocuments/LibraryDocumentCreationInfoV6
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>LibraryDocumentCreationInfoV6</code>.
   * @alias module:model/libraryDocuments/LibraryDocumentCreationInfoV6
   * @class
   */
  ...
  /**
   * Constructs a <code>LibraryDocumentCreationInfoV6</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/libraryDocuments/LibraryDocumentCreationInfoV6} obj Optional instance to populate.
   * @return {module:model/libraryDocuments/LibraryDocumentCreationInfoV6} The populated <code>LibraryDocumentCreationInfoV6</code> instance.
   */
   ...
   * @member {module:model/libraryDocuments/LibraryDocumentCreationInfoV6.SharingModeEnum} sharingMode
   */
  exports.prototype['sharingMode'] = undefined;
  /**
   * State of the library document.
   * @member {module:model/libraryDocuments/LibraryDocumentCreationInfoV6.StateEnum} state
   */
  exports.prototype['state'] = undefined;
  /**
   * Status of the library document
   * @member {module:model/libraryDocuments/LibraryDocumentCreationInfoV6.StatusEnum} status
   */
  exports.prototype['status'] = undefined;
  /**
   * A list of one or more library template types
   * @member {Array.<module:model/libraryDocuments/LibraryDocumentCreationInfoV6.TemplateTypesEnum>} templateTypes
   */
