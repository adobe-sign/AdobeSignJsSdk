...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/libraryDocuments/DigitalSignatureInfo', 'model/libraryDocuments/LibDocEventDeviceLocation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DigitalSignatureInfo'), require('./LibDocEventDeviceLocation'));
  } else {
    // Browser globals (root is window)
    if (!root.SwaggerJsClient) {
      root.SwaggerJsClient = {};
    }
    root.SwaggerJsClient.LibraryDocumentEvent = factory(root.SwaggerJsClient.ApiClient, root.SwaggerJsClient.DigitalSignatureInfo, root.SwaggerJsClient.LibDocEventDeviceLocation);
  }
}(this, function(ApiClient, DigitalSignatureInfo, LibDocEventDeviceLocation) {
  'use strict';
  ...
  /**
   * The LibraryDocumentEvent model module.
   * @module model/libraryDocuments/LibraryDocumentEvent
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>LibraryDocumentEvent</code>.
   * @alias module:model/libraryDocuments/LibraryDocumentEvent
   * @class
   */
  ...
  /**
   * Constructs a <code>LibraryDocumentEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/libraryDocuments/LibraryDocumentEvent} obj Optional instance to populate.
   * @return {module:model/libraryDocuments/LibraryDocumentEvent} The populated <code>LibraryDocumentEvent</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('deviceLocation')) {
        obj['deviceLocation'] = LibDocEventDeviceLocation.constructFromObject(data['deviceLocation']);
      }
   ...
   * @member {module:model/libraryDocuments/LibDocEventDeviceLocation} deviceLocation
   */
   ...
   * @member {module:model/libraryDocuments/DigitalSignatureInfo} digitalSignatureInfo
   */
   ...
   * @member {module:model/libraryDocuments/LibraryDocumentEvent.ParticipantRoleEnum} participantRole
   */
   ...
   * @member {module:model/libraryDocuments/LibraryDocumentEvent.TypeEnum} type
   */
