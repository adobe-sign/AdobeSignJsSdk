...
(function(root, factory) {
   ...
   * @module model/libraryDocuments/DigitalSignatureInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>DigitalSignatureInfo</code>.
   * @alias module:model/libraryDocuments/DigitalSignatureInfo
   * @class
   */
   ...
   * @param {module:model/libraryDocuments/DigitalSignatureInfo} obj Optional instance to populate.
   * @return {module:model/libraryDocuments/DigitalSignatureInfo} The populated <code>DigitalSignatureInfo</code> instance.
   */
