...
(function(root, factory) {
   ...
   * @module model/webhooks/PageInfo
   * @version 6.0.0
   */

  /**
   * Constructs a new <code>PageInfo</code>.
   * @alias module:model/webhooks/PageInfo
   * @class
   */
   ...
   * @param {module:model/webhooks/PageInfo} obj Optional instance to populate.
   * @return {module:model/webhooks/PageInfo} The populated <code>PageInfo</code> instance.
   */
